...
public class DecoratorPattern_JHD6_Test {

	private static Logger logger = Logger.getLogger(DecoratorPattern_JHD6_Test.class);
	...
	public void writePatternAnalysisResult() {
		...
		File output = new File(outputDir, "DecoratorPatternAnalysisResult.xml");
