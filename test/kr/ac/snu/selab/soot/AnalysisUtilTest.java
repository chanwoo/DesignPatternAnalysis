			...
			for (SootClass aClass : classList) {
				for (SootMethod aMethod : aClass.getMethods()) {
					...
					if (aMethod.getName().equals(
						...
						mip_methodParamToReturn1 = au
								.analyzeMethodParamToReturn(aMethod, i,
										hierarchy, classMap);
					}
					...
					if (aMethod.getName().equals(
						...
						// preparation for analyzeMethodParamToReturnTest
						mip_methodParamToReturn2 = au
								.analyzeMethodParamToReturn(aMethod, i,
										hierarchy, classMap);
						mip_methodParamToReturn3 = au
								.analyzeMethodParamToReturn(aMethod, d,
										hierarchy, classMap);
					}
