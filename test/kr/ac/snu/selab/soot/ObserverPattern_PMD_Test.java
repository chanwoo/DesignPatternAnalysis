...
import kr.ac.snu.selab.soot.analyzer.ObserverPattern;
...
public class ObserverPattern_PMD_Test {

	private static Logger logger = Logger.getLogger(ObserverPattern_PMD_Test.class);

	private static final String PROJECTS_NAME = "pmd";
	...
	public void writePatternAnalysisResult() {
		...
		File output = new File(outputDir, "ObserverPatternAnalysisResult.xml");
	...
	private class TestRunner extends AbstractAnalyzer {
		...
		protected void analyze(List<SootClass> classList, Hierarchy aHierarchy) {
			...
			PatternAnalysis analysis = new ObserverPattern();
