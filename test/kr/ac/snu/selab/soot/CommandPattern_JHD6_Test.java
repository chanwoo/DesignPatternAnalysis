...
import kr.ac.snu.selab.soot.analyzer.CommandPattern;
...
public class CommandPattern_JHD6_Test {

	private static Logger logger = Logger.getLogger(CommandPattern_JHD6_Test.class);
	...
	public void writePatternAnalysisResult() {
		...
		File output = new File(outputDir, "CommandPatternAnalysisResult.xml");
	...
	private class TestRunner extends AbstractAnalyzer {
		...
		protected void analyze(List<SootClass> classList, Hierarchy aHierarchy) {
			...
			PatternAnalysis analysis = new CommandPattern();
