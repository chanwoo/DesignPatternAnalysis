...
import kr.ac.snu.selab.soot.analyzer.StrategyPattern;
...
public class StrategyPattern_JHD6_Test {

	private static Logger logger = Logger.getLogger(StrategyPattern_JHD6_Test.class);
	...
	public void writePatternAnalysisResult() {
		...
		File output = new File(outputDir, "StrategyPatternAnalysisResult.xml");
	...
	private class TestRunner extends AbstractAnalyzer {
		...
		protected void analyze(List<SootClass> classList, Hierarchy aHierarchy) {
			...
			PatternAnalysis analysis = new StrategyPattern();
