...
import kr.ac.snu.selab.soot.analyzer.AdapterPattern;
...
public class AdapterPattern_JHD6_Test {

	private static Logger logger = Logger.getLogger(AdapterPattern_JHD6_Test.class);
	...
	public void writePatternAnalysisResult() {
		...
		File output = new File(outputDir, "AdapterPatternAnalysisResult.xml");
	...
	private class TestRunner extends AbstractAnalyzer {
		...
		protected void analyze(List<SootClass> classList, Hierarchy aHierarchy) {
			...
			PatternAnalysis analysis = new AdapterPattern();
